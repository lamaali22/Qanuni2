  ...
  void updateReviewWithReporter(String reviewDocumentId) async {
    ...
    if (user != null) {
      ...
      DocumentSnapshot reviewSnapshot =
          await FirebaseFirestore.instance.collection('reviews').doc(reviewDocumentId).get();

      // Check if the user's email is already in the array of reporters
      Map<String, dynamic>? reviewData = reviewSnapshot.data() as Map<String, dynamic>?;
...
// Check if numOfReports is 3 or greater
      ...
      if (updatedNumOfReports >= 3) {
        // Delete the comment
        await FirebaseFirestore.instance.collection('reviews').doc(reviewDocumentId).delete();
