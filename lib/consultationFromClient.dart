...
class _BookingListScreenState extends State<BookingClientScreen>
  ...
  void dispose() {
   ...
   @override
  void didUpdateWidget(BookingClientScreen oldWidget) {
    super.didUpdateWidget(oldWidget);
    // Sort the appointments when the widget is updated
    upcomingAppointments.sort((a, b) => b.startTime.compareTo(a.startTime));
