...
Future<bool> showDeleteConfirmationDialog(BuildContext context) async {
 ...
 // If the user confirms the deletion, proceed with the delete logic
  if (confirmDelete) {
    try {  
      ...
      if (user != null) {
        ...
        // Delete user documents in 'lawyers' collection
        await _db
            .collection('lawyers')
...
*/
        ...
        Token().updateTokenInDB(userEmail, false, "lawyers");
